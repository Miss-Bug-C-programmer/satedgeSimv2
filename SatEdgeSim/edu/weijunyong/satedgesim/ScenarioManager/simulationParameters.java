...
public class simulationParameters { 
	...
	public static String RL_SCENARIO_PROFILE = "default";
	public static String RL_TASK_SOURCE_MODE = "current";
	public static String RL_SUCCESS_PROFILE = "default";
	public static String RL_ACTION_MASK_MODE = "visible_only";
	public static double RL_MIN_LINK_SURVIVAL_MARGIN_SEC = 0.0;
	public static boolean RL_IS_CONTROLLED_SCENARIO = false;
	public static long RL_SERVER_SEED = 0L;
